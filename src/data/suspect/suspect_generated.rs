...
impl<'a> Suspect<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.face_img {
            builder.add_face_img(x);
        }
    ...
    pub fn name(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(Suspect::VT_NAME, None)
    }
    #[inline]
    pub fn age(&self) -> u32 {
    ...
    pub fn face_img(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(Suspect::VT_FACE_IMG, None)
    }
    #[inline]
    pub fn mood(&self) -> Mood {
        self._tab
            .get::<Mood>(Suspect::VT_MOOD, Some(Mood::Happy))
            .unwrap()
    }
    #[inline]
    pub fn location(&self) -> Option<Location<'a>> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<Location>>(Suspect::VT_LOCATION, None)
    }
    #[inline]
    pub fn path(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Location<'a>>>> {
        self._tab.get::<flatbuffers::ForwardsUOffset<
            flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Location>>,
        >>(Suspect::VT_PATH, None)
    }
}
...
impl flatbuffers::Verifiable for Suspect<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<Location>>(
                "location",
                Self::VT_LOCATION,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Location>>,
...
pub struct SuspectArgs<'a> {
    ...
    pub path: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Location<'a>>>>,
    >,
}
...
impl<'a: 'b, 'b> SuspectBuilder<'a, 'b> {
    ...
    pub fn add_face_img(&mut self, face_img: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Suspect::VT_FACE_IMG, face_img);
    }
    #[inline]
    pub fn add_mood(&mut self, mood: Mood) {
        self.fbb_
            .push_slot::<Mood>(Suspect::VT_MOOD, mood, Mood::Happy);
    }
    #[inline]
    pub fn add_location(&mut self, location: flatbuffers::WIPOffset<Location<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<Location>>(Suspect::VT_LOCATION, location);
    }
    #[inline]
    pub fn add_path(
        &mut self,
        path: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Location<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Suspect::VT_PATH, path);
    }
    #[inline]
...
pub fn size_prefixed_root_as_suspect(
    buf: &[u8],
) -> Result<Suspect, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_suspect_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<Suspect<'a>>,
) {
