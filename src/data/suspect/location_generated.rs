...
impl<'a> Location<'a> {
    ...
    pub fn street(&self) -> Option<&'a str> {
        self._tab
            .get::<flatbuffers::ForwardsUOffset<&str>>(Location::VT_STREET, None)
    }
}
...
impl<'a: 'b, 'b> LocationBuilder<'a, 'b> {
    ...
    pub fn add_pos(&mut self, pos: &Position) {
        self.fbb_
            .push_slot_always::<&Position>(Location::VT_POS, pos);
    }
    #[inline]
    pub fn add_street(&mut self, street: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Location::VT_STREET, street);
    }
    #[inline]
